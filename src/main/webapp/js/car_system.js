...
function render_preProvenceCarModal(param){
    ...
    $.ajax({
        ...
        url:'/smartpark/provencecardetail',
        dataType:'json',
...
function loadTspdCar(param) {
    ...
    $.ajax({
        ...
        url:'/smartpark/sepcialfredetail',
        dataType:'json',
